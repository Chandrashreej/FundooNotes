...
export class EditnotesComponent implements OnInit {
 ...
 if(this.backgroundColour == null ||this.backgroundColour == "undefined")
 {
   this.backgroundColour = this.data.notesdata.color;
 }
 if(this.dateAndTime == null ||this.backgroundColour == "undefined")
 {
